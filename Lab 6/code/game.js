...
Level.prototype.obstacleAt = function (pos, size) {
  ...
  //consider the sides and to of bottom of the level as walls
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  //find if there is an obstacle at newPos
  var obstacle = level.obstacleAt(newPos, this.size);

  //move if there is not a wall there
  if (obstacle != "wall")
    this.pos = newPos;
};
